...
const SUPABASE_URL = "COLE_AQUI_SUA_PROJECT_URL";      // ex: https://dgmqgcdvcdjetjarcpbj.supabase.co
const SUPABASE_ANON_KEY = "COLE_AQUI_SUA_CHAVE_ANON";  // sb_publishable_vmrpf_9lB_ZF81M7UicusA_nCdXxtUO
